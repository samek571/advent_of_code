...
class Solution:
    ...
    there is this nlogn algo that gets it correct that i have stolen from gpt, however
    its not a theft if you know how to enhance the time complexity!
...
if __name__ == "__main__": main()
    ...
    #     res = 0
    #     for i in range(si, ei+1):
    #         a = bisect.bisect_left(mink, i)
    #         b = bisect.bisect_left(maxk, i)
    #         if a == len(mink) or b == len(maxk):
    #             continue
    #         x = mink[a]
    #         y = maxk[b]
    #         v = max(x, y)
